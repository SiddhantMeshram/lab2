...
void PrePrio::AddProcess(shared_ptr<Process> process) {
...
shared_ptr<Process> PrePrio::GetInActiveQueue() {
...
shared_ptr<Process> PrePrio::GetNextProcess() {
